<x-layouts.dashboard>
    <div class="d-flex flex-column gap-4">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h2 class="font-outfit fs-3 fw-bold text-dark mb-1">Add New Hostel</h2>
                <p class="text-secondary small mb-0">List a new property for Kota students.</p>
            </div>
        </div>

        <!-- Form Card -->
        <div class="card border border-light-subtle rounded-2xl p-4 p-md-5 bg-white">
            <form action="{{ route('owner.hostels.store') }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column gap-4">
                @csrf
                ...
                <div>
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control rounded-xl @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required placeholder="e.g. Kota Premium Residency">
                            @error('title')
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control rounded-xl @error('description') is-invalid @enderror" id="description" name="description" rows="5" required placeholder="Describe room amenities, food quality, hostel rules, security details, etc.">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control rounded-xl @error('address') is-invalid @enderror" id="address" name="address" rows="2" required placeholder="e.g. Plot No. 12, Landmark City, Kunhari, Kota">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-sm-6 col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control rounded-end-xl @error('monthly_rent') is-invalid @enderror" id="monthly_rent" name="monthly_rent" value="{{ old('monthly_rent', 0) }}" min="0" required>
                                @error('monthly_rent')
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light rounded-start-xl border-end-0">₹</span>
                                <input type="number" class="form-control rounded-end-xl @error('security_deposit') is-invalid @enderror" id="security_deposit" name="security_deposit" value="{{ old('security_deposit') }}" min="0">
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            ...
                            <input type="number" class="form-control rounded-xl @error('total_rooms') is-invalid @enderror" id="total_rooms" name="total_rooms" value="{{ old('total_rooms') }}" min="0">
                            @error('total_rooms')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            ...
                            <input type="number" class="form-control rounded-xl @error('available_rooms') is-invalid @enderror" id="available_rooms" name="available_rooms" value="{{ old('available_rooms') }}" min="0">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="d-flex flex-wrap gap-4 mt-2">
                                <div class="form-check">
                                    <input class="form-check-input @error('room_types') is-invalid @enderror" type="checkbox" name="room_types[]" value="single" id="room_type_single" {{ is_array(old('room_types')) && in_array('single', old('room_types')) ? 'checked' : '' }}>
                                    <label class="form-check-label text-dark small fw-medium" for="room_type_single">Single Room</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input @error('room_types') is-invalid @enderror" type="checkbox" name="room_types[]" value="double" id="room_type_double" {{ is_array(old('room_types')) && in_array('double', old('room_types')) ? 'checked' : '' }}>
                                    <label class="form-check-label text-dark small fw-medium" for="room_type_double">Double Room</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input @error('room_types') is-invalid @enderror" type="checkbox" name="room_types[]" value="triple" id="room_type_triple" {{ is_array(old('room_types')) && in_array('triple', old('room_types')) ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" step="0.00000001" class="form-control rounded-xl @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{ old('latitude') }}" placeholder="e.g. 25.149622">
                            @error('latitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" step="0.00000001" class="form-control rounded-xl @error('longitude') is-invalid @enderror" id="longitude" name="longitude" value="{{ old('longitude') }}" placeholder="e.g. 75.841233">
                            @error('longitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="url" class="form-control rounded-xl @error('google_map_url') is-invalid @enderror" id="google_map_url" name="google_map_url" value="{{ old('google_map_url') }}" placeholder="e.g. https://maps.google.com/?q=...">
                ...
                <div>
                    ...
                    <div class="col-12">
                        <label for="gallery_images" class="form-label small fw-semibold text-secondary">Upload Hostel Images (Select Multiple)</label>
                        ...
                        <div class="form-text small text-secondary">You can select up to 20 images. Supported formats: JPEG, PNG, JPG, WEBP. Max size: 5MB per file.</div>
                ...
                <div>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control rounded-xl @error('meta_title') is-invalid @enderror" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="Leave empty to auto-generate">
                            @error('meta_title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control rounded-xl @error('meta_description') is-invalid @enderror" id="meta_description" name="meta_description" rows="3" placeholder="Write a short summary (160 characters recommended)"></textarea>
                ...
                <div class="d-flex align-items-center justify-content-end gap-2 border-top pt-4">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-4">Save Hostel</button>
                </div>
            </form>
        </div>
    </div>
